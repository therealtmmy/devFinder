...
const GithubUser = () => {
  return (
    <div className='User'>
        <div>
          <img 
          src="https://avatars.githubusercontent.com/u/107879861?v=4" 
          alt="avatar" />
        </div>
        ...
        <div>
          <div className='UserName'>
              <p 
               style={{
                fontSize: "20px", 
                fontWeight: "700"}}>The Octocat</p>
              <p>Joined 25 Jan 2011</p>
          </div>
              <a 
              href="" 
              style={{
                color: "blue"}}>@Octocat</a>
          ...
          <div className='UserSocials'>
            ...
            <span><FaMapMarkerAlt/> San Francisco</span>
